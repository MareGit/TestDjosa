...
SELECT [BusinessEntityID],
       ...
       [rowguid],
       [ModifiedDate]
FROM   [Person].[Person] OUTER APPLY [AdditionalContactInfo].[nodes]('declare namespace ci="http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ContactInfo"; 
    /ci:AdditionalContactInfo') AS [ContactInfo]([ref])
WHERE  [AdditionalContactInfo] IS NOT NULL;
GO
ALTER AUTHORIZATION
    ON [Person].[vAdditionalContactInfo]
    TO SCHEMA OWNER;
GO
