...
FROM   [Person].[Person] AS [p] CROSS APPLY [p].[Demographics].[nodes](N'declare default element namespace "http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/IndividualSurvey"; 
    /IndividualSurvey') AS [IndividualSurvey]([ref])
WHERE  [Demographics] IS NOT NULL;
GO
ALTER AUTHORIZATION
    ON [Sales].[vPersonDemographics]
    TO SCHEMA OWNER;
GO
