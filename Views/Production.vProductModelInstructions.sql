...
SELECT [ProductModelID],
       ...
       [rowguid],
       [ModifiedDate]
FROM   [Production].[ProductModel] CROSS APPLY [Instructions].[nodes](N'declare default element namespace "http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelManuInstructions"; 
...
GO
ALTER AUTHORIZATION
    ON [Production].[vProductModelInstructions]
    TO SCHEMA OWNER;
GO
